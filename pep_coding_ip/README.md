...
- [x] 4. `Edit distance` https://leetcode.com/problems/edit-distance/
...
- [x] 8. `Non Adjacent Sum` https://practice.geeksforgeeks.org/problems/stickler-theif/0
...
- [x] 8. `Number of ways to partition array in to k subsets` https://leetcode.com/problems/partition-to-k-equal-sum-subsets/
...
- [x] 4. `Course schedule` https://leetcode.com/problems/course-schedule-ii/
- [x] 5. `Most stones removed` https://leetcode.com/problems/most-stones-removed-with-same-row-or-column/
- [x] 6. `Bipartite graph` https://practice.geeksforgeeks.org/problems/bipartite-graph/1
...
- [ ] 5. `First negative Integer in k sized window` https://www.geeksforgeeks.org/first-negative-integer-every-window-size-k/
